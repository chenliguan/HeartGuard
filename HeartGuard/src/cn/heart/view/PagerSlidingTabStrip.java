 ...
 * @description 主页面滑动页实现类。PagerSlidingTabStrip是GitHub上的一个开源框架，由Andreas Stuetz编写。
 *              它可以完成和ActionBar Tab基本类似的功能，不过由于是完全开源的， 我们可以随意修改其中的代码，扩展性非常好。
 * @author Guan
 * @date 2015-6-10 下午3:37:19
 * @version 1.0
 */
...
public class PagerSlidingTabStrip extends HorizontalScrollView {
	...
	private int tabTextColor = 0xFF666666; // TAB文字初始化颜色
